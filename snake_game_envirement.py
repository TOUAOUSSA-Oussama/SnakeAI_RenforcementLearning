...
class SnakeGameAI:
    ...
    def play_step(self, action):
        ...
        # 2. move
        self._move(action) # update the head selon l'action
    ...
    def _move(self, action):
        ...
        ## si action = [0, 1, 0] => tourner a droite 
            ...
            if idx_dir_actuelle == 3:
                new_dir = dir_Possible[0]
            else :
                new_dir = dir_Possible[idx_dir_actuelle+1]
        ## si action = [0, 0, 1] => tourne a gauche
        else :
            if idx_dir_actuelle == 0:
                new_dir = dir_Possible[3]
            else :
                new_dir = dir_Possible[idx_dir_actuelle-1]
        # mettre a jour la nouvelle direction
